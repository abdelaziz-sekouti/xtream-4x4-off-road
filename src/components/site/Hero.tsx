...
export const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden bg-night"
    >
      {/* Background */}
      ...
      <div className="container-x relative z-10 grid lg:grid-cols-12 gap-10 items-center pt-32 pb-20">
        <div className="lg:col-span-7 animate-fade-up">
          <span className="eyebrow text-primary mb-6">
            Off-Road Adventure · Morocco & Africa
          </span>
          ...
          <p className="text-white/80 text-lg md:text-xl max-w-xl mt-8 font-light leading-relaxed">
            Custom 4x4 tours, professional rally training & expert vehicle
            preparation.
          ...
          <div className="grid grid-cols-3 gap-6 mt-16 max-w-lg">
            {[
              ...
              <div key={s.l} className="border-l-2 border-primary pl-4">
                <div className="text-white font-display font-black text-3xl">
                  {s.n}
                </div>
        ...
        {/* Quick booking card */}
        <div
          className="lg:col-span-5 lg:justify-self-end w-full max-w-md animate-fade-up"
            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-night border border-white/10 text-white placeholder:text-white/40 pl-10 pr-4 py-3 text-sm focus:outline-none focus:border-primary transition-colors"
                />
              </div>
              <div className="relative">
                <Calendar
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 hidden md:flex flex-col items-center gap-2 text-white/60">
        <span className="text-[10px] font-display font-bold tracking-[0.3em]">
          SCROLL
        </span>
