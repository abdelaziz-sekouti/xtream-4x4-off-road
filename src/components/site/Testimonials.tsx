    ...
    <section className="py-24 md:py-32 bg-muted">
      <div className="container-x">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span
            className="eyebrow text-primary justify-center"
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {reviews.map((r) => (
            <article
              key={r.name}
              className="bg-background p-8 shadow-card relative group hover:shadow-hard transition-all duration-500 hover:-translate-y-1"
            >
              <Quote
